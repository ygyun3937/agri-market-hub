...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#1c2a36',
      display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        background: '#253748', border: '1px solid #354d65', borderRadius: 12,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: '#eef5fb' }}>농수산 통합관제센터</div>
            <div style={{ fontSize: 12, color: '#87b8d4', marginTop: 4 }}>로그인하여 대시보드를 이용하세요</div>
          </div>
        </div>
